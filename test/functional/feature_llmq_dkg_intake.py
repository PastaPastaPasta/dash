...
Adversarial P2P tests for DKG message-intake hardening:
  - codex/F-026: pushed DKG messages (qcontrib/qcomplaint/qjustify/qpcommit) from a
    peer that is not MNAuth-verified are rejected before retention.
  - claude/F-014: oversized DKG payloads are rejected (before deserialization /
    retention) even from a verified peer.
