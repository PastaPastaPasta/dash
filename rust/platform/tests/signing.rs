...
//! src/test/data/platform/dpp_st_vectors.json (platform v4.0.0, protocol
...
use dash_platform_ffi::st::{self, AssetLockProofInput, NewIdentityKey, ASSET_LOCK_KEY_ID};
use dash_platform_ffi::types::KeyInfo;
