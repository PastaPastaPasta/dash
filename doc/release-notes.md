...
This is a patch release fixing three remotely reachable crashes, along with
additional security hardening, networking and CoinJoin reliability fixes, and
compatibility updates for newer build and CI toolchains.
