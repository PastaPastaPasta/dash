...
RUN apt-get update && apt-get install $APT_ARGS g++-8 && rm -rf /var/lib/apt/lists/*
...
RUN apt-get update && apt-get install $APT_ARGS g++-8-multilib && rm -rf /var/lib/apt/lists/*
RUN apt-get update && apt-get install $APT_ARGS g++-8-arm-linux-gnueabihf && rm -rf /var/lib/apt/lists/*
