...
// See https://github.com/dashpay/dips/blob/master/dip-0006.md for more details
    struct LLMQParams {
        ...
        bool isEmpty() const { return LLMQParams().type == LLMQType::LLMQ_NONE; };
 ...
 *
 */
    constexpr auto LLMQ_TEST = LLMQParams{
 ...
 *
 */
    constexpr auto LLMQ_TEST_V17 = LLMQParams{
 ...
 *
 */
    constexpr auto LLMQ_DEVNET = LLMQParams{
 ...
 *
 */
    constexpr auto LLMQ_50_60 = LLMQParams{
 ...
 *
 */
    constexpr auto LLMQ_400_60 = LLMQParams{
 ...
 */
    constexpr auto LLMQ_400_85 = LLMQParams{
 ...
 */
    constexpr auto LLMQ_100_67 = LLMQParams{
    ...
    static constexpr std::array<LLMQParams, 7> available_llmqs = {
            LLMQParam::LLMQ_TEST,
            LLMQParam::LLMQ_TEST_V17,
            LLMQParam::LLMQ_DEVNET,
            LLMQParam::LLMQ_50_60,
            LLMQParam::LLMQ_400_60,
            LLMQParam::LLMQ_400_85,
            LLMQParam::LLMQ_100_67
    }; // available_llmqs
