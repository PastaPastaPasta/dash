...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "protx register_prepare", 8, "payoutAddress", true },
    { "protx register_prepare_legacy", 2, "collateralIndex" },
    { "protx register_prepare_legacy", 3, "coreP2PAddrs", true },
    { "protx register_prepare_legacy", 8, "payoutAddress", true },
    { "protx register_prepare_evo", 2, "collateralIndex" },
    { "protx register_prepare_evo", 3, "coreP2PAddrs", true },
    { "protx register_prepare_evo", 8, "payoutAddress", true },
    { "protx register_prepare_evo", 10, "platformP2PAddrs", true },
    { "protx register_prepare_evo", 11, "platformHTTPSAddrs", true },
    { "protx register_shared_prepare", 2, "shares" },
    { "protx register_shared_prepare", 3, "coreP2PAddrs", true },
    { "protx register_shared_prepare", 7, "earlyPeriodBlocks" },
    { "protx register_shared_prepare", 8, "earlyPenalty" },
    { "protx revoke", 3, "reason" },
    { "protx revoke", 5, "submit" },
    { "protx shared_combine", 2, "signatures" },
    { "protx shared_combine", 3, "submit" },
    { "protx dissolve", 2, "actorIndex" },
    { "protx dissolve", 3, "fee" },
    { "protx dissolve", 4, "submit" },
    ...
    { "protx update_registrar_legacy", 4, "payoutAddress", true },
