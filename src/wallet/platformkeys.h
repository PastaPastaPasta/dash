 ...
 * documents, contracts or the network. It is only compiled with
 * --enable-platform-gui and only used through the interfaces::Wallet
 * platform key provider methods.
 *
 * References:
