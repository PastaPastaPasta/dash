...
CJContext::CJContext(CChainState& chainstate, CConnman& connman, CTxMemPool& mempool, const CActiveMasternodeManager* mn_activeman,
...
#endif // ENABLE_WALLET
    server{std::make_unique<CCoinJoinServer>(chainstate, connman, *dstxman, mempool, mn_activeman, mn_sync)}
{}
