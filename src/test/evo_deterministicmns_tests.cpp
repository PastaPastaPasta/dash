...
//
// Reachable from CTxMemPool::removeForBlock() (any block carrying such a ProTx) and from
// AcceptToMemoryPool()'s InstantSend "waiting for tx" branch, which calls removeProTxConflicts()
// directly.
