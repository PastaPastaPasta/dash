    ...
    LIMITED_WHILE(fuzzed_data_provider.ConsumeBool(), 10000) {
        CallOneOf(
            ...
            [&] {
                ...
                try {
                    auto_file.read(reinterpret_cast<char*>(arr.data()), fuzzed_data_provider.ConsumeIntegralInRange<size_t>(0, 4096));
            ...
            [&] {
                ...
                try {
                    auto_file.write(reinterpret_cast<const char*>(arr.data()), fuzzed_data_provider.ConsumeIntegralInRange<size_t>(0, 4096));
                } catch (const std::ios_base::failure&) {
                }
            },
            [&] {
